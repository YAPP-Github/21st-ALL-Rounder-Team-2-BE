package com.yapp.artie.domain.gallery.domain.service;

import com.yapp.artie.domain.category.domain.Category;
import com.yapp.artie.domain.category.service.CategoryService;
import com.yapp.artie.domain.gallery.domain.dto.exhibition.CreateExhibitionRequest;
import com.yapp.artie.domain.gallery.domain.dto.exhibition.ExhibitionByCategoryResponse;
import com.yapp.artie.domain.gallery.domain.dto.exhibition.ExhibitionByDateResponse;
import com.yapp.artie.domain.gallery.domain.dto.exhibition.ExhibitionByDayQueryResponse;
import com.yapp.artie.domain.gallery.domain.dto.exhibition.ExhibitionByMonthlyResponse;
import com.yapp.artie.domain.gallery.domain.dto.exhibition.ExhibitionDetailResponse;
import com.yapp.artie.domain.gallery.domain.dto.exhibition.ExhibitionDraftResponse;
import com.yapp.artie.domain.gallery.domain.dto.exhibition.UpdateExhibitionRequest;
import com.yapp.artie.domain.gallery.domain.entity.exhibition.Exhibition;
import com.yapp.artie.domain.gallery.domain.entity.exhibition.PinType;
...
import com.yapp.artie.domain.gallery.exception.ExhibitionNotFoundException;
import com.yapp.artie.domain.gallery.exception.NotOwnerOfExhibitionException;

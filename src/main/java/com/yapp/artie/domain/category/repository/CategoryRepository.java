package com.yapp.artie.domain.category.repository;
...
public interface CategoryRepository extends JpaRepository<Category, Long> {
  ...
  @Query("select new com.yapp.artie.domain.archive.dto.cateogry.CategoryDetailResponse(c.id, c.name, c.sequence) from Category c where c.user = :user order by c.sequence")
